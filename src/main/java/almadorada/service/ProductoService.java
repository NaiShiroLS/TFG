...
public class ProductoService {
    ...
    public int contarTotalProductos() {
        ...
        try (Connection conn = getConnection();
            ...
            System.err.println("Error al contar total de productos: " + e.getMessage());
        }
        return 0;
    }
    /**
     * Obtiene la imagen (como arreglo de bytes) de un producto por su ID
     * @param id ID del producto
     * @return Optional con los bytes de la imagen si existe, vacío si no hay imagen o no se encuentra el producto
     */
    public Optional<byte[]> obtenerImagenPorId(int id) {
