...
public class PedidosAnadirEditar extends JDialog {
    ...
    private JTextArea txtDireccion; // Correctly declared as JTextArea
    ...
    private void initUI() {
        ...
        btnEliminarProducto.setPreferredSize(new Dimension(160, 40)); // Fixed width and height
        btnEliminarProducto.setMinimumSize(new Dimension(160, 40)); // Ensure it doesn't shrink
        btnEliminarProducto.setMaximumSize(new Dimension(160, 40)); // Ensure it doesn't grow
        btnEliminarProducto.setCursor(new Cursor(Cursor.HAND_CURSOR));
        productsPanel.add(btnEliminarProducto, gbc);
        gbc.anchor = GridBagConstraints.CENTER; // Restablecer anchor

        productRow++;
        // Table for products
        gbc.gridx = 0; gbc.gridy = productRow;
        gbc.gridwidth = PRODUCT_SECTION_COLUMNS; // Tabla abarca todas las columnas
        gbc.weighty = 1.0; // Table expands vertically
        ...
        tablaProductos.setDefaultRenderer(Object.class, new DefaultTableCellRenderer() {
            ...
            public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
                ...
                // Ensure centering for all columns
                ((JLabel) c).setHorizontalAlignment(JLabel.CENTER);
                return c;
            }
        });
        // Apply the centering renderer to each column
        ...
        productRow++;
        // Subtotal and Total Labels (right-aligned)
        gbc.gridx = 0; gbc.gridy = productRow; gbc.gridwidth = PRODUCT_SECTION_COLUMNS; // Ajustar a nuevas columnas
        gbc.weightx = 1.0;
        gbc.fill = GridBagConstraints.NONE; // Don't stretch these labels horizontally
        ...
        formContentPanel.add(Box.createRigidArea(new Dimension(0, 20))); // Spacing before buttons


        // Add the main formContentPanel to a JScrollPane
        ...
        // Se añadió el fondo para que coincida con los otros paneles
        buttonPanel.setBackground(ColorPalette.WHITE_LIGHT);
        // Se modificó el borde para que coincida con los otros paneles
        ...
        btnGuardar.setFont(ColorPalette.FONT_BUTTON); // Ensure bold font
        btnGuardar.setPreferredSize(new Dimension(160, 40)); // Fixed size for Save button
        ...
        btnCancelar.setFont(ColorPalette.FONT_BUTTON); // Ensure bold font
        btnCancelar.setPreferredSize(new Dimension(140, 40)); // Fixed size for Cancel button
        ...
        // --- Action Listeners (FUNCTIONAL LOGIC - UNCHANGED) ---
        ...
        pack(); // Pack the dialog to its preferred size
