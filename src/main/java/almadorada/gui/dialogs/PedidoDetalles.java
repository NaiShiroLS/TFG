...
public class PedidoDetalles extends JFrame {
    ...
    private void initializeComponents() {
        ...
        estadoCombo.setCursor(new Cursor(Cursor.HAND_CURSOR));
        ...
        gbc.gridwidth = 2;
        gbc.weightx = 2.0;
        panelCliente.add(Box.createHorizontalGlue(), gbc);
        ...
        table.getTableHeader().setFont(ColorPalette.FONT_SUBTITLE);
        ...
        scrollPane.setBorder(BorderFactory.createLineBorder(ColorPalette.GRAY_VERY_LIGHT, 1));
        ...
        lblMonto.setFont(ColorPalette.FONT_TOTAL);
        ...
        if (userSelection == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                ...
                for (int row = 0; row < table.getRowCount(); row++) {
                    BaseColor rowBgColor = alternar ? pdfTableOddRowBg : pdfTableEvenRowBg;
